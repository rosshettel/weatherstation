	...
	$routeProvider
	    ...
	    .when('/weatherRadar', {
		   templateUrl: 'static/templates/fullScreenImage.html',
             ...
             resolve: {
                 imageUrl: function () { return 'http://api.wunderground.com/api/25d29ac708c38d34/animatedradar/q/60614.gif?width=640&height=480&newmaps=1&smooth=1&noclutter=1&timelabel=1'; }
             }
	    });
}]);